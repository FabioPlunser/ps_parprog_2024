set terminal gif animate delay 1/24 # set gif to animate in a frame delay of 30 ms
...
do for [i=1:int(STATS_blocks)] {
   splot 'data.dat' index (i-1) with points ls 2 lc rgb '#f82c00' ps 0.4 # for each datapoint plot the point
}